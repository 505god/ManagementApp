...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = NSLocalizedString(@"HeaderPullToRefresh", @"");
        self.releaseToRefreshText = NSLocalizedString(@"HeaderReleaseToRefresh", @"");
        self.refreshingText = NSLocalizedString(@"Refreshing", @"");
    }
    return self;
}
...
- (void)updateTimeLabel
{
    ...
    // 3.显示日期
    self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"%@%@",NSLocalizedString(@"LastUpDate", @""),time];
}
