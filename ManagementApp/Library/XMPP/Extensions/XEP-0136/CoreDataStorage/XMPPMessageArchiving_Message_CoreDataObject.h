...
@property (nonatomic, copy) NSString * messageStr;  // Shadow (binary data, written to disk)
...
@property (nonatomic, copy) NSString * bareJidStr;  // Shadow (binary data, written to disk)
