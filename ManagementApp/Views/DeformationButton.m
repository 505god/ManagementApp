...
- (void)initSettingWithColor:(UIColor*)color{
    ...
    bgView.hidden = YES;
    bgView.layer.cornerRadius = self.height/2.0;
...
//    [self addTarget:self action:@selector(loadingAction) forControlEvents:UIControlEventTouchUpInside];
    ...
    [self.forDisplayButton setBackgroundImage:[[self imageWithColor:color cornerRadius:0] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10)] forState:UIControlStateNormal];
    [self.forDisplayButton setBackgroundImage:[[self imageWithColor:color cornerRadius:0] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10)] forState:UIControlStateHighlighted];
